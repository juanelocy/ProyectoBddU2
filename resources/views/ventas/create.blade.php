        ...
        <div class="col-md-8 offset-md-2">
            ...
            <form action="{{ route('ventas.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" id="Cantidad" name="Cantidad" class="form-control" value="{{ old('Cantidad') }}" min="1" required>
                    @error('Cantidad')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" id="Monto_Total" name="Monto_Total" class="form-control" value="{{ old('Monto_Total') }}" step="0.01" required>
                    @error('Monto_Total')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select id="ID_Comerciante" name="ID_Comerciante" class="form-select" required>
                        <option value="" disabled selected>Seleccione un comerciante</option>
